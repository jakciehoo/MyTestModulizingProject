...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/jakciehoo/B_Project"
  ...
  s.source       = { :git => "https://github.com/jakciehoo/B_Project.git", :tag => s.version.to_s }
  ...
  s.source_files  = "B_Project/B_Project/*/*.{h,m}"
