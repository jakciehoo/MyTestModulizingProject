...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/jakciehoo/A_Project"
  ...
  s.source       = { :git => "https://github.com/jakciehoo/A_Project.git", :tag => s.version.to_s }
  ...
  s.source_files  = "A_Project/A_Project/*/*.{h,m}"
